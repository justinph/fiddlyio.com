...
<div style="border: 1px solid black; background-color: white; padding: 5px 5px 5px 5px; width: <?php echo $_GET['dw']; ?>px;"> 
	<h2>FedEx Short</h2><br />
	<span class="details">2002 <span class="dslash">/</span> Typography in Motion <span class="dslash">/</span>  Jan Jancourt <span class="dslash">/</span>  Video (0:15) <span class="dslash">/</span> QT 6 MPEG4</span><br /><br />
	...
	<OBJECT CLASSID="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" WIDTH="340" HEIGHT="256" CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab#version=6,0,2,0">
			...
			<PARAM NAME="HREF" VALUE="../movies/fedex_340_240.mov">
			...
			HREF="../movies/fedex_340_240.mov" type="video/quicktime" BGCOLOR="#000000" BORDER="0" 
...
<br /><br />
	<div id="critcont">
		...
		<span class='details'>
		A short typographic animation exploring the concepts of time and motion, as they relate to the nature of FedEx and their business.
